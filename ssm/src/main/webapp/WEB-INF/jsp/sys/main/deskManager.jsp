...
<body class="childrenBody">
	...
	function getLangDate(){
	    ...
	    document.getElementById("nowTime").innerHTML = "亲爱的超级管理员，"+timeValue+"好！ 欢迎使用。当前时间为： "+newDate+"　"+week;
	...
	layui.use(['form','element','layer','jquery'],function(){
	    ...
	    //最新文章列表
	    $.get("${pageContext.request.contextPath }/resources/json/newsList.json",function(data){
	        var hotNewsHtml = '';
	        for(var i=0;i<5;i++){
	            hotNewsHtml += '<tr>'
	    ...
	    //用户数量
	    $.get("${pageContext.request.contextPath }/resources/json/userList.json",function(data){
