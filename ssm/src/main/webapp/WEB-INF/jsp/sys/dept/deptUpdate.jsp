...
<form class="layui-form" method="post" id="frm">
	<div class="layui-form-item">
		...
		<div class="layui-inline">
			...
			<div class="layui-input-inline">
				<input type="text" name="ordernum" value="${dept.ordernum }" lay-verify="required"  placeholder="排序码" autocomplete="off" class="layui-input">
			</div>
		</div>
	</div>
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<input type="text" name="name" lay-verify="required" value="${dept.name }" autocomplete="off"
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<input type="text" name="loc" lay-verify="required" autocomplete="off" value="${dept.loc }"
				   placeholder="请输入公司地址" class="layui-input">
		</div>
	</div>
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<textarea placeholder="请输入部门备注" name="remark" class="layui-textarea">${dept.remark }</textarea>
		</div>
	</div>
	<div class="layui-form-item">
		<div class="layui-inline">
			...
			<div class="layui-input-inline">
				<input type="radio" name="spread" value="1" title="是" ${dept.spread==1?'checked':'' }>
				<input type="radio" name="spread" value="0" title="否" ${dept.spread==0?'checked':'' }>
			</div>
		</div>
		<div class="layui-inline">
...
<script type="text/javascript">
    layui.use(['form','jquery','layer'],function(){
        ...
        form.on('submit(updateDept)', function(data){
            ...
            //使用ajax提交
            $.ajax({
                url:'${pageContext.request.contextPath }/dept/updateDept.action',
                type:'POST',
    ...
    $(function(){
    	var url="${pageContext.request.contextPath }/dept/loadLeftZtree.action"
        	$.post(url,function(zNodes){
				...
				var node = treeObj.getNodeByParam("id", pid);//应该被选中节点
				//选中节点
