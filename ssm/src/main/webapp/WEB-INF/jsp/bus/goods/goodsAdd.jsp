...
<form class="layui-form" method="post" id="frm">
	<div class="layui-form-item">
		...
		<div class="layui-inline">
			...
			<div style="margin-bottom:0px;padding:0px;position:absolute;top: 0px;left:102%" >
         		<img alt="商品图片" width="220px" id="goods_img" height="270px" style="border-radius:5px" src="${pageContext.request.contextPath }/resources/images/defaulttitle.jpg">
       		</div>
		</div>
	</div>
	<div class="layui-form-item">
	...
	<div class="layui-form-item">
		<div class="layui-inline">
			...
			<div class="layui-input-inline">
				<input type="text" name="dangernum"  lay-verify="required/number" autocomplete="off"
