...
<form class="layui-form" id="searchForm" method="post">
    ...
    <div class="layui-form-item" style="text-align: center;">
        ...
        <button type="reset" class="layui-btn layui-btn-warm">清空</button>
        	...
        	<a class="layui-btn layui-btn-normal addcustomer_btn">添加</a>
    ...
    function reloadTable(id){
     ...
     layui.use(['form','layer','table','jquery'],function(){
        ...
        tableIns = table.render({
            elem: '#customerList',
            url : '${pageContext.request.contextPath }/customer/queryAllCustomers.action',
            cellMinWidth : 95,
            page : true,
            height : "full-200",
            limits : [10,15,20,25],
        ...
        $(".search_btn").on("click",function(){
            ...
            table.reload('customerListTable', {
                url: '${pageContext.request.contextPath }/customer/queryAllCustomers.action?'+params
            });
        });
        ...
        $(".addcustomer_btn").click(function(){
            var index = layui.layer.open({
                ...
                type : 2,//ifream层
                area:["800px","500px"],
                content : "${pageContext.request.contextPath }/customer/toCustomerAdd.action",
        ...
        function updateCustomer(data){
            var index = layui.layer.open({
                ...
                type : 2,
                area:["800px","500px"],
                content : "${pageContext.request.contextPath }/customer/toUpdateCustomer.action?id="+data.id,
                success : function(layero, index){
                    setTimeout(function(){
                        layui.layer.tips('点击此处返回客户列表', '.layui-layer-setwin .layui-layer-close', {
                            tips: 3
        ...
        table.on('tool(customerList)', function(obj){
            ...
            if(layEvent === 'edit'){ //编辑
                ...
                layer.confirm('确定删【'+data.customername+'】客户吗？',{icon:3, title:'提示信息'},function(index){
                    $.post("${pageContext.request.contextPath }/customer/deleteCustomer.action",{
        ...
        $(".delAll_btn").click(function(){
            ...
            if(data.length > 0) {
                ...
                layer.confirm('确定删除选中的客户？', {icon: 3, title: '提示信息'}, function (index) {
                    $.post("${pageContext.request.contextPath }/customer/batchDeleteCustomer.action?"+ids,function(data){
                        //刷新table
                        tableIns.reload();
                        //关闭提示框
                        layer.close(index);
