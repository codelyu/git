...
<form class="layui-form" method="post" id="frm">
	<div class="layui-form-item">
		<div class="layui-inline">
			...
			<div class="layui-input-inline">
				<input type="text" name="providername" value="${provider.providername }" lay-verify="required"  placeholder="供应商名称" autocomplete="off" class="layui-input">
			</div>
		...
		<div class="layui-inline">
			...
			<div class="layui-input-inline">
				<input type="text" name="zip" value="${provider.zip }" placeholder="邮政编号" autocomplete="off" class="layui-input">
			</div>
		</div>
	</div>
	<div class="layui-form-item">
		<div class="layui-inline">
			...
			<div class="layui-input-inline">
				<input type="text" name="address" value="${provider.address }" id="name" lay-verify="required" autocomplete="off"
				   placeholder="请输入供应商地址" class="layui-input">
			</div>
		</div>
		<div class="layui-inline">
			<label class="layui-form-label">电话</label>
			<div class="layui-input-inline">
				 <input type="text" name="telephone"  value="${provider.telephone }" id="loginname" lay-verify="required" autocomplete="off"
	...
	<div class="layui-form-item">
		<div class="layui-inline">
			...
			<div class="layui-input-inline">
				<input type="text" name="connectionperson"  value="${provider.connectionperson }"  lay-verify="required" autocomplete="off"
	...
	<div class="layui-form-item">
		...
		<div class="layui-inline">
			...
			<div class="layui-input-inline">
				 <input type="text" name="account" value="${provider.account }"     autocomplete="off"
	...
	<div class="layui-form-item">
		<div class="layui-inline">
			...
			<div class="layui-input-inline">
				<input type="text" name="email" value="${provider.email }"   autocomplete="off"
		...
		<div class="layui-inline">
			...
			<div class="layui-input-inline">
				 <input type="text" name="fax" value="${provider.fax }"   autocomplete="off"
