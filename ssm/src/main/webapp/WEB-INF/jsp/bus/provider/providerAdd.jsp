	...
	<div class="layui-form-item">
		<div class="layui-inline">
			...
			<div class="layui-input-inline">
				<input type="text" name="providername" lay-verify="required"  placeholder="供应商名称" autocomplete="off" class="layui-input">
			</div>
		</div>
		<div class="layui-inline">
...
<script type="text/javascript">
    layui.use(['form','jquery','layer'],function(){
        ...
        form.on('submit(addProvider)', function(data){
            ...
            //使用ajax提交
            $.ajax({
                url:'${pageContext.request.contextPath }/provider/addProvider.action',
                type:'POST',
